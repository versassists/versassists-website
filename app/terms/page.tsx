...
export const metadata: Metadata = {
  ...
  description: "VersAssist terms and conditions of service.",
};
    ...
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-2xl mx-auto px-6 text-gray-600 leading-relaxed space-y-8">
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">3. Setup Fee</h2>
            <p>A one-time setup fee of $299.99 is required to customize and integrate services with your existing workflows. This fee covers onboarding, tool setup, workflow design, and initial training.</p>
          </div>
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">4. Payment & Billing</h2>
            <p>Services are billed at the agreed-upon hourly rate. Detailed billing reports are provided. Hours purchased do not expire. Payment is due according to the terms specified in your service agreement.</p>
          </div>
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-3">5. No Lock-In</h2>
