...
export default function Home() {
  return (
    <>
      {/* ════════════ HERO ════════════ */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-[#1a1a2e] to-[#16213e]">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 py-40 flex flex-col items-center">
          {/* Badge */}
          ...
          {/* Headline */}
          <h1 className="mt-10 text-center text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-white leading-tight tracking-tight">
          ...
          {/* Sub */}
          <p className="mt-8 text-center text-lg sm:text-xl text-gray-400 max-w-xl leading-relaxed">
          ...
          <div className="mt-16 flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/services"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full border border-white/20 text-white font-semibold text-lg hover:bg-white/[0.06] transition-all"
            >
              Explore Services
            </Link>
          </div>
          ...
          {/* Trust */}
          <div className="mt-20 flex flex-wrap justify-center gap-x-10 gap-y-4 text-sm text-gray-500">
      ...
      <section className="py-28 lg:py-36 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
          <p className="text-sm font-semibold tracking-wider uppercase text-primary mb-4">What We Do</p>
          <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-5">
            Services That Scale With You
          </h2>
          <p className="text-center text-gray-500 max-w-lg text-lg mb-20">
            ...
            {services.map((service) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-center font-bold text-gray-900 mb-3">{service.title}</h3>
          ...
          <Link href="/services" className="mt-14 inline-flex items-center gap-2 text-primary font-semibold hover:gap-3 transition-all">
      ...
      <section className="py-28 lg:py-36 bg-white">
        <div className="max-w-5xl mx-auto px-6 flex flex-col items-center">
          <p className="text-sm font-semibold tracking-wider uppercase text-primary mb-4">How It Works</p>
          <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-5">
            Three Simple Steps
          </h2>
          <p className="text-center text-gray-500 max-w-lg text-lg mb-20">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              { num: "01", icon: Target, title: "Book a Discovery Call", desc: "A free 15-minute call where we learn about your business, challenges, and goals. We recommend the fastest path to results." },
              { num: "02", icon: Users, title: "Get Matched", desc: "We assign AI-trained virtual assistants who specialize in your focus areas. Onboarded to your workflows within 48 hours." },
              { num: "03", icon: TrendingUp, title: "Scale & Grow", desc: "Delegate immediately. Track progress through detailed reports. Scale up or down as your business evolves. No lock-in." },
            ].map((step) => (
              <div key={step.num} className="flex flex-col items-center">
                <span className="text-7xl font-black text-gray-100 leading-none mb-6 select-none">{step.num}</span>
      ...
      <section className="py-28 lg:py-36 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
          <p className="text-sm font-semibold tracking-wider uppercase text-primary mb-4">Why VersAssist</p>
          <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-5">
          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.title} className="flex flex-col items-center bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
                <div className="w-12 h-12 rounded-xl bg-primary/[0.08] flex items-center justify-center mb-6">
                  <item.icon className="w-6 h-6 text-primary" />
                </div>
                <h3 className="text-center font-bold text-gray-900 mb-3">{item.title}</h3>
                <p className="text-center text-gray-500 text-sm leading-relaxed">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ════════════ STATS ════════════ */}
      <section className="py-24 bg-gradient-to-br from-gray-900 via-[#1a1a2e] to-[#16213e]">
      ...
      <section className="py-28 lg:py-36 bg-white">
        <div className="max-w-6xl mx-auto px-6 flex flex-col items-center">
          <p className="text-sm font-semibold tracking-wider uppercase text-primary mb-4">Testimonials</p>
          <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-5">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="bg-gray-50 rounded-2xl p-10 border border-gray-100">
                <div className="flex gap-1 mb-6">
                  {[...Array(5)].map((_, j) => (
                    <Star key={j} className="w-5 h-5 fill-yellow-400 text-yellow-400" />
                  ))}
                </div>
                <p className="text-gray-700 leading-relaxed text-[1.05rem] mb-8">&ldquo;{t.quote}&rdquo;</p>
      ...
      <section className="py-28 lg:py-36 bg-gray-50">
        <div className="max-w-2xl mx-auto px-6 flex flex-col items-center">
          <p className="text-sm font-semibold tracking-wider uppercase text-primary mb-4">FAQ</p>
          ...
          <Link href="/faq" className="mt-12 inline-flex items-center gap-2 text-primary font-semibold hover:gap-3 transition-all">
      ...
      <section className="py-28 lg:py-36 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative rounded-3xl bg-gradient-to-br from-gray-900 via-[#1a1a2e] to-[#16213e] px-8 py-20 sm:px-16 sm:py-24 overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <p className="text-center text-gray-400 max-w-lg text-lg leading-relaxed mb-12">
